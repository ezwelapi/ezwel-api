...
//        		src.setMaxTokenLength(KoreanAnalyzer.this.maxTokenLength);
	 ...
	 */
	@APIOperation(description="determin whether the original term is returned or not if a input word is analyzed morphically.")
	 ...
	 */
	@APIOperation(description="determin whether the original compound noun is returned or not if a input word is analyzed morphically.")
	 ...
	 */
	@APIOperation(description="determin whether the analyzer is running for a query processing")
	 ...
	 */
	@APIOperation(description="determin whether word segment analyzer is processing")
