...
<div id="mainContiner">
	<div>
		<ul>
			<li style="width:100%;" class="heightTarget"><h2>Interface Test Site</h2></li>
		</ul>
	</div>
	<div>
		<ul class="titleContainer">
			<li><span class="title heightTarget">Input Data Setup</span></li>
			...
			<li>
				<select id="httpAgentId" name="httpAgentId">
					...
					<option value="10058059" httpApiKey="80b640b94717fe103223b69789c0bfcdi">콘도24</option>
	...
	<div>
		<ul>
			<li style="width:55%;height:200px;">
				<textarea class="heightTarget" placeholder="API 입력 파라메터(JSON)" id="inputJson" name="inputJson" style="width:99%;height:200px;"></textarea>
			</li>
			<li style="width:45%;height:200px;">
				<div>
					<textarea placeholder="API 요청 헤더(JSON)" id="inputHeader" name="inputHeader" style="width:100%;height:150px;float:right;"></textarea>
				</div>
				<div>
					<textarea placeholder="body" id="inputMailContents" name="inputMailContents" style="width:100%;height:40px;float:right;margin-top:4px;"></textarea>
				</div>			
			</li>
		</ul>
	</div>
	<div>
		<ul class="titleContainer">
			<li style="width:100%;padding-top:8px;"><span class="title heightTarget">Output Data</span></li>
		</ul>
	</div>
	<div id="outputContainer">
		<ul>
			<li style="width:98.3%;">
				<div placeholder="API 응답 결과(JSON)" id="outputJson" name="outputJson" style="width:100%;background:#ffffff;overflow:auto;position:relative;top:0px;bottom:0px;"></div>
			</li>
		</ul>
	</div>
</div>
