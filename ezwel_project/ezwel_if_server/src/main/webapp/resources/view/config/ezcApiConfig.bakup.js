			...
			,define: function( storeFile ) {
				...
				function(require, exports, module) {
					...
					require("../config").defineOptions(Editor.prototype, "editor", {
					    rtlText: {
					        set: function(val) {
					        	$.logger.debug("## editor rtlText set ##", arguments);
					...
					function onChangeSelection(e, editor) {
						//$.logger.debug("## onChangeSelection ##", arguments);
					...
					function onCommandEmitted(commadEvent) {
						$.logger.debug("[START] onCommandEmitted ##", arguments);
					    ...
					    $.logger.debug("[END] commadEvent.editor.session.$bidiHandler.isMoveLeftOperation: ", commadEvent.editor.session.$bidiHandler.isMoveLeftOperation);
					}
				...
				ace.define("ezc-api/inline_editor",["require","exports","module","ace/line_widgets","ace/editor","ace/virtual_renderer","ace/lib/dom","ace/commands/default_commands"], 
				function(require, exports, module) {
					"use strict";
					...
					require("ace/commands/default_commands").commands.push({
					    ...
					    bindKey: "F3",
					    exec: function(editor) {
					    	$.logger.debug("## default_commands exec ##", arguments);
				...
				ace.define("ace/test/asyncjs/assert",["require","exports","module","ace/lib/oop"], 
				function(require, exports, module) {
				...
				ace.define("ace/test/asyncjs/async",["require","exports","module"], 
				function(require, exports, module) {
				...
				ace.define("ace/test/mockrenderer",["require","exports","module"], 
				function(require, exports, module) {
					"use strict";
				...
				ace.define("ezc-api/dev_util",["require","exports","module","ace/lib/dom","ace/lib/event","ace/range","ace/edit_session","ace/undomanager","ace/lib/oop","ace/lib/dom","ace/range","ace/editor","ace/test/asyncjs/assert","ace/test/asyncjs/async","ace/undomanager","ace/edit_session","ace/test/mockrenderer","ace/lib/event_emitter"], 
					function(require, exports, module) {
						var dom = require("ace/lib/dom");
						...
						function warn() {
						    ...
						    if (!/at Object.InjectedScript.|@debugger eval|snippets:\/{3}|<anonymous>:\d+:\d+/.test(s)) {
						        $.logger.error("trying to access to global variable");
						    }
						}
				...
				ace.define("ezc-api/file_drop",["require","exports","module","ace/config","ace/lib/event","ace/ext/modelist","ace/editor"], 
					function(require, exports, module) {
...
//						color:rgb(185, 6, 144);\
				...
				ace.define("ace/ext/whitespace",["require","exports","module","ace/lib/lang"], 
					function(require, exports, module) {
						"use strict";
				...
				ace.define("ezc-api/doclist",["require","exports","module","ace/edit_session","ace/undomanager","ace/lib/net","ace/ext/modelist"], 
					function(require, exports, module) {
						"use strict";
						...
						function initDoc(file, path, doc) {
							$.logger.debug("ezc-api/doclist initDoc", arguments);
						...
						var hugeDocs = require.toUrl ? {
						    ...
						    "../../common/comp/ace-builds/src/ace.js": "",
						    "../../common/comp/ace-builds/src-min/ace.js": ""
						};
						*/
						
						$.logger.warn(">> modelist", modelist);
						...
						modelist.modes.forEach(function(m) {
						    ...
						    $.logger.debug("# doclist > modelist.modes.forEach > path : " + path);
						...
						*/
						...
						function sort(list) {
							$.logger.debug("# doclist > sot", arguments);
						...
						function prepareDocList(docs) {
						    ...
						    for (var path in docs) {
						        ...
						        $.logger.debug("# prepareDocList", doc);
						    }
						...
						function loadDoc(name, callback) {
						    ...
						    path = $.gf_cont.ctxp + $.gf_cont.reqNamespace + "/manager/findXML";
						...
						function saveDoc(name, callback) {
							$.logger.debug("# doclist > saveDoc", arguments);
						...
						function upload(url, data, callback) {
							$.logger.debug("# doclist > upload", arguments);
						...
						module.exports = {
						    fileCache: fileCache,
						    configXml: prepareDocList({ configXmlUrl: {name: "Operating env XML", wrapped: true} }),
						    docs: sort(prepareDocList(docs)),	// Mode Example
						...
						module.exports.all = {
							"Real ConfigXml": module.exports.configXml,
				...
				ace.define("ezc-api/layout",["require","exports","module","ace/lib/dom","ace/lib/event","ace/edit_session","ace/undomanager","ace/virtual_renderer","ace/editor","ace/multi_select","ace/theme/textmate"], 
					function(require, exports, module) {
						"use strict";
				...
				ace.define("ezc-api/util",["require","exports","module","ace/lib/dom","ace/lib/event","ace/edit_session","ace/undomanager","ace/virtual_renderer","ace/editor","ace/multi_select"], 
					function(require, exports, module) {
						"use strict";
				...
				ace.define("ace/ext/elastic_tabstops_lite",["require","exports","module","ace/editor","ace/config"], 
					function(require, exports, module) {
						"use strict";
				...
				ace.define("ace/occur",["require","exports","module","ace/lib/oop","ace/range","ace/search","ace/edit_session","ace/search_highlight","ace/lib/dom"], 
					function(require, exports, module) {
						"use strict";
				...
				ace.define("ace/commands/occur_commands",["require","exports","module","ace/config","ace/occur","ace/keyboard/hash_handler","ace/lib/oop"], 
					function(require, exports, module) {
				...
				ace.define("ace/commands/incremental_search_commands",["require","exports","module","ace/config","ace/lib/oop","ace/keyboard/hash_handler","ace/commands/occur_commands"], 
					function(require, exports, module) {
				...
				ace.define("ace/incremental_search",["require","exports","module","ace/lib/oop","ace/range","ace/search","ace/search_highlight","ace/commands/incremental_search_commands","ace/lib/dom","ace/commands/command_manager","ace/editor","ace/config"], 
					function(require, exports, module) {
						"use strict";
				...
				ace.define("ezc-api/token_tooltip",["require","exports","module","ace/lib/dom","ace/lib/oop","ace/lib/event","ace/range","ace/tooltip"], 
					function(require, exports, module) {
						"use strict";
				...
				ace.define("ace/ext/menu_tools/overlay_page",["require","exports","module","ace/lib/dom"], 
					function(require, exports, module) {
						'use strict';
				...
				ace.define("ace/ext/options",["require","exports","module","ace/ext/menu_tools/overlay_page","ace/lib/dom","ace/lib/oop","ace/lib/event_emitter","ace/ext/modelist","ace/ext/themelist"], 
					function(require, exports, module) {
						"use strict";
				...
				ace.define("ace/ext/statusbar",["require","exports","module","ace/lib/dom","ace/lib/lang"], 
					function(require, exports, module) {
						"use strict";
				...
				ace.define("ace/snippets",["require","exports","module","ace/lib/oop","ace/lib/event_emitter","ace/lib/lang","ace/range","ace/anchor","ace/keyboard/hash_handler","ace/tokenizer","ace/lib/dom","ace/editor"], 
					function(require, exports, module) {
						"use strict";
				...
				ace.define("ace/ext/emmet",["require","exports","module","ace/keyboard/hash_handler","ace/editor","ace/snippets","ace/range","resources","resources","tabStops","resources","utils","actions","ace/config","ace/config"], 
					function(require, exports, module) {
						"use strict";
				...
				ace.define("ace/autocomplete/popup",["require","exports","module","ace/virtual_renderer","ace/editor","ace/range","ace/lib/event","ace/lib/lang","ace/lib/dom"], 
					function(require, exports, module) {
						"use strict";
				...
				ace.define("ace/autocomplete",["require","exports","module","ace/keyboard/hash_handler","ace/autocomplete/popup","ace/autocomplete/util","ace/lib/event","ace/lib/lang","ace/lib/dom","ace/snippets"], 
					function(require, exports, module) {
						"use strict";
				...
				ace.define("ace/ext/language_tools",["require","exports","module","ace/snippets","ace/autocomplete","ace/config","ace/lib/lang","ace/autocomplete/util","ace/autocomplete/text_completer","ace/editor","ace/config"], 
					function(require, exports, module) {
						"use strict";
				...
				ace.define("ace/ext/beautify",["require","exports","module","ace/token_iterator"], 
					function(require, exports, module) {
						"use strict";
				...
				ace.define("ezc-api/config",["require","exports","module","ace/lib/fixoldbrowsers","ace/ext/rtl","ace/multi_select","ezc-api/inline_editor","ezc-api/dev_util","ezc-api/file_drop","ace/config","ace/lib/dom","ace/lib/net","ace/lib/lang","ace/lib/useragent","ace/lib/event","ace/theme/textmate","ace/edit_session","ace/undomanager","ace/keyboard/hash_handler","ace/virtual_renderer","ace/editor","ace/ext/whitespace","ezc-api/doclist","ezc-api/layout","ezc-api/util","ace/ext/elastic_tabstops_lite","ace/incremental_search","ezc-api/token_tooltip","ace/config","ace/worker/worker_client","ace/split","ace/ext/options","ace/ext/statusbar","ace/ext/emmet","ace/placeholder","ace/snippets","ace/ext/language_tools","ace/ext/beautify","ace/keyboard/keybinding","ace/commands/command_manager"], 
					function(require, exports, module) {
						...
						commands.addCommand({
						    ...
						    exec: function(arg) {
						    	$.logger.debug("# [START] commands.addCommand");
						    	$.logger.debug(arg);
						...
						doclist.pickDocument = function(name) {
							//파일 내용조회
							$.logger.debug("# doclist.pickDocument : " + name);
						...
						doclist.pickFolder = function(name) {
							//폴더 아래 파일 목록 조회
							$.logger.debug("# doclist.pickFolder : " + name);
						...
						optionsPanel.add({
						    Main: {
						        "저장소": {
						            ...
						            items: doclist.all,
						            position: -102,
						            onchange: doclist.pickFolder,
						            getValue: function() {
						                return env.editor.session.name || "";
						            }
						        },
						        "문서": {
						            type: "select",
			...
			,init: function() {
				...
				// 1. 유저 폴더 목록 조회
				$.gf_tx.ajax( $.fn_config.cont.txURL.fileList, { storeType: "root" }
				,{
					fn_success: function( response ) {
						
						if(response.code !== "1000") {
							//error
							var contents  = "Code: "+ response.code + "<br>";
								contents += "Message: " + response.message;
								
							$.alert(contents, { 
									elemId : $.gf_func.replaceAll($.fn_config.cont.txURL.fileList, "/", "-"),
									css: {
										div: {width:"500px"},
							...
							$.fn_config.define( response );
							
							$.logger.warn("[START] ace.require(['ezc-api/config']", window);
							$.logger.warn("#### ace ####", ace);
							
							ace.require(["ezc-api/config"], function(m) {
								$.logger.debug("require(['ezc-api/config'] m =>", m);
			...
			cont: {
				...
				,txURL: {
					//  $.fn_config.cont.txURL.fileList
					fileList: $.gf_cont.reqNamespace + "/manager/storeList"
				}
			}
			,define: {
				//  $.fn_config.define.editor
				editor: {}
			}
			,util: {
			...
			,tx: {
				fileList: function( storeFileDir, isInitEditor ) {
					
					$.gf_tx.ajax( $.fn_config.cont.txURL.fileList, { storeType: "child", storeFileDir: storeFileDir }
					,{
					fn_success: function( file ) {
						
						//조회 실패
						if(file.code !== "1000") {
							var contents  = "Code: "+ file.code + "<br>";
								contents += "Message: " + file.message;
						...
						//조회 성공
							...
							if(file.fileList == null || file.fileList.length == 0) {
								...
								$.each(file.fileList, function(idx, val) {
			...
			,bind : {
						...
						if( $.fn_config.control[id] ) {
							...
							switch (discernment) {
								...
								case 'SELECT': 
									...
									break;
								case 'TEXT': 
									$.logger.warn("#TEXT discernment : " + discernment);
									break;
								case 'CHECKBOX': 
							...
							$.fn_config.control[id]( editor, $elem );
						}
					});
					
					/**
					 * 문서파일 목록이 존재하면 첫번째 파일의 정보를 조회하여 에디터에 세팅한다.
					 */
				...
				// $.fn_config.bind.editor
				editor: function() {
					var editor = ace.edit($.fn_config.cont.selt.editor);
					$.fn_config.define.editor[$.fn_config.cont.selt.editor] = editor; 
			...
			,initialize: function() {
				...
				$.gf_tx.ajax( $.fn_config.cont.txURL.fileList, { storeType: "root" }
				,{
					fn_success: function( folder ) {
						
						$.logger.debug("-> folder", folder);
						
						//조회 실패
						if(folder.code !== "1000") {
							var contents  = "Code: "+ folder.code + "<br>";
								contents += "Message: " + folder.message;
						...
						//조회 성공
							...
							if(folder.fileList == null || folder.fileList.length == 0) {
								//임시저장 사용자 디렉토리가 존재하지 않으면 에디터 초기화
								$.fn_config.bind.editor();
							}
							else {
