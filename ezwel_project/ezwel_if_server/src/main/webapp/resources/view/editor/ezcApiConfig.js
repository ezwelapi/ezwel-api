		 ...
		 apiConfig: {
			cont: {
				...
				,txURL: {
					...
					,storeAllList: $.gf_cont.reqNamespace + "/manager/storeAllList"	// $.apiConfig.cont.txURL.applyXML
				}
			},
			provider: {
			...
			,define: function( storeFile ) {
				...
				function updateLineDirection(e, renderer) {
					$.logger.debug("## updateLineDirection ##");
					$.logger.debug(arguments);
				...
				define("ezc-api/inline_editor",["require","exports","module","ace/line_widgets","ace/editor","ace/virtual_renderer","ace/lib/dom","ace/commands/default_commands"], function(require, exports, module) {
				"use strict";
				...
				assert.AssertionError.prototype.toString = function() {
					$.logger.debug("## assert.AssertionError.prototype.toString ##");
					$.logger.debug(arguments);
			...
			/*	modelist.modes.forEach(function(m) {
				...
				*/
				...
				$.each(storeFile.fileList, function(i, data){
					...
					//$.logger.warn(">>> documentData", documentData);
					...
					if( data.fileType == "D" ) {
						...
						documentData[data.prntName][data.name] = data;
					}
				});
				...
				function saveDoc(name, callback) {
					$.logger.debug("#saveDoc", arguments);
					alert("saveDoc");
				    ...
				    if (parts[0] == "docs")
				        ...
				        path = "lib/" + path;
				    */
				    path = $.apiConfig.cont.txURL.saveXML
				    
				    upload(path, doc.session.getValue(), callback);
				}
				
				function upload(url, data, callback) {
					$.logger.debug("#upload", arguments);
					alert("saveDoc");
				...
				for(var key in documentData) {
					module.exports[key] = sort(prepareDocList(documentData[key]));
				}
				...
				define("ezc-api/layout",["require","exports","module","ace/lib/dom","ace/lib/event","ace/edit_session","ace/undomanager","ace/virtual_renderer","ace/editor","ace/multi_select","ace/theme/textmate"], function(require, exports, module) {
				"use strict";
				...
				define("ezc-api/util",["require","exports","module","ace/lib/dom","ace/lib/event","ace/edit_session","ace/undomanager","ace/virtual_renderer","ace/editor","ace/multi_select"], function(require, exports, module) {
				"use strict";
				...
				define("ezc-api/token_tooltip",["require","exports","module","ace/lib/dom","ace/lib/oop","ace/lib/event","ace/range","ace/tooltip"], function(require, exports, module) {
				"use strict";
				...
				commands.addCommand({
				    ...
				    exec: function(arg) {
				        ...
				        $.gf_tx.ajax( $.apiConfig.cont.txURL.saveXML, { 
					        	 storeFileDir: $.apiConfig.util.getUserId()
					        	,xmlCont: session.getValue()
					        }
							,{
								fn_success: function( response ) {
									
									$.logger.debug("#saveXML", response);
									...
									//저장 성공
										...
										//에디터 하단 커멘드라인
										env.editor.cmdLine.setValue("saved complete "+ response.storeFileName);
									}
								}
							}
						);
			...
			,init: function() {
				...
				,{
					fn_success: function( response ) {
						...
						$.logger.debug("# storeAllList", response);
					}
				});
			}
		}
