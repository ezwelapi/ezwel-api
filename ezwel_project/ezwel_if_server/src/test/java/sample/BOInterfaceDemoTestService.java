 ...
 * @date   2018. 11. 19.
 */
public class BOInterfaceDemoTestService extends TestCase {

	private static final Logger logger = LoggerFactory.getLogger(BOInterfaceDemoTestService.class);
	 ...
	 */
	public BOInterfaceDemoTestService()  throws Exception {
