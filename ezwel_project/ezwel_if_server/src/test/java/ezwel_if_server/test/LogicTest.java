...
public class LogicTest {
	...
	public void testAsset01() {
		...
		img = new EzcFaclImg();
		img.setPartnerImgUrl("http://tourimage.interpark.com/Product/Hotel/CAVAEAAEAK/500/1001565129_4_18803.jpg");
		ezcFaclImgList.add(img);
		img = new EzcFaclImg();
		img.setPartnerImgUrl("http://tourimage.interpark.com/Product/Hotel/CAVAEAAEAK/500/1001565129_2_54210.jpg");
		ezcFaclImgList.add(img);
		img = new EzcFaclImg();
		img.setPartnerImgUrl("http://tourimage.interpark.com/Product/Hotel/CAVAEAAEAK/500/1001565129_4_18803.jpg");
		ezcFaclImgList.add(img);
		...
		inEzcFaclImg.setFaclCd(new BigDecimal("36148"));
		//기존 저장된 이미지 정보 조회
		List<String> ezcFaclImgDBList = new ArrayList<String>();
		ezcFaclImgDBList.add("http://tourimage.interpark.com/Product/Hotel/CAVAEAAEAK/500/1001565129_4_18803-111.jpg");
		ezcFaclImgDBList.add("http://tourimage.interpark.com/Product/Hotel/CAVAEAAEAK/500/1001565129_4_18803-222.jpg");
		ezcFaclImgDBList.add("http://tourimage.interpark.com/Product/Hotel/CAVAEAAEAK/500/1001565129_4_18803.jpg");
		ezcFaclImgDBList.add("http://tourimage.interpark.com/Product/Hotel/CAVAEAAEAK/500/1001565129_2_54210.jpg");
