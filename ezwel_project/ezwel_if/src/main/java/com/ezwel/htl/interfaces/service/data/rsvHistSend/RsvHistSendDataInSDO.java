...
public class RsvHistSendDataInSDO extends AbstractDTO {
	...
	public List<RsvHistSendOptionsInSDO> getOptions() {
		return options;
	}

	public void setPenalty(List<RsvHistSendOptionsInSDO> options) {
